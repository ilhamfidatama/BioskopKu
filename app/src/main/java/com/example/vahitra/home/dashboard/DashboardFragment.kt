...
//    var tv_saldo = view?.findViewById(R.id.tv_saldo) as TextView
//    var iv_profile = view?.findViewById(R.id.iv_profile) as ImageView
//    var rv_tayang = view?.findViewById(R.id.rv_tayang) as RecyclerView
//    var rv_segera = view?.findViewById(R.id.rv_segera) as RecyclerView
